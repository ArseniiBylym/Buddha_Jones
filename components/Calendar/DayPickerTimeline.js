...
import { Row, Col, Dropdown, Button } from './../../components';

// Styles
import s from './DayPickerTimeline.css';
import { IconArrowLeftYellow, IconArrowRightYellow } from './../Icons';
...
const propTypes = {
    ...
    limitFromDate: PropTypes.object.isRequired,
    limitToDate: PropTypes.object.isRequired
};
...
DayPickerTimeline.propTypes = propTypes;
DayPickerTimeline.defaultProps = defaultProps;
