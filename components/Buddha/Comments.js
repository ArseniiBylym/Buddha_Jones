            ...
            <CommentForm
                ...
                description={
                    this.state.comments.length > 0
                        ? this.state.comments.length.toString() + ' comment' + (this.state.comments.length > 1 ? 's' : '')
                        : this.props.noCommentsLabel
                }
                descriptionIsDim={true}
                status={
                ...
                label="Save comment"
                labelSaving="Saving comment"
                labelSuccess="Comment posted"
                labelError="Comment could not be saved, try again"
