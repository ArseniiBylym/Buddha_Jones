...
class ClientsFilter extends React.Component {
    ...
    handleClientChange(e) {
        ...
        // Close dropdown
        if (this.dropdownContainer && typeof this.dropdownContainer.closeDropdown !== 'undefined') {
    ...
    render() {
        return (
            <DropdownContainer
                ...
                value={this.props.valueLabel !== null ? this.props.valueLabel : this.state.selected.label}
            >
...
ClientsFilter.propTypes = propTypes;
ClientsFilter.defaultProps = defaultProps;
