...
import { Layout, ProjectPicker, Input, TextArea, Select, Checkmark, Button } from './../../../components';
import TimeTrackingCalendar from './TimeTrackingCalendar';

// Styles
import s from './TimeTrackingWorkerEntry.css';
import { IconSendSubmit } from './../../../components/Icons';
...
class PageTimeTrackingWorkerEntry extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (this.props.user !== nextProps.user && !this.state.activitiesLoading && nextProps.user) {
            this.fetchActivities();
        }
    }
