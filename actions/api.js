...
// GraphicRequest Status type IDs sync with DB
export const GRAPHIC_REQUEST_STATUS_TYPE = {
    Draft:              1,
    Approved:           2,
    Accepted:           3
};
...
export const PROJECT_CAMPAIGN                       = '/project-campaign';
export const PROJECT_CAMPAIGN_PEOPLE                = '/project-campaign-people';
...
export const ASSIGN_CONTACT_TO_PROJECT_CAMPAIGN     = '/assign-customer-contact-to-project-campaign';
